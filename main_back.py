...
def main(page: flet.Page):
    ...
    def validate_url(e):
        ...
        if not url or not is_valid_url(url):
            ...
            combine_button.visible = True  # Deshabilita el botón de combinación
        ...
        if "Error" in clip_id:
            ...
            download_button.disabled = True
            download_button.update()
            combine_button.visible = False  # Deshabilita el botón de combinación
            combine_button.update()
            return
        ...
        if output_file and (os.path.exists(output_file) or os.path.exists(clip_id + "-video.mp4")):
            ...
            download_button.disabled = True
            download_button.update()
            combine_button.visible = True  # Habilita el botón de combinación
            combine_button.update()
        else:
            result_text.value = ""
            result_text.update()
    ...
    finish_dialog = AlertDialog(
        title=Text("Descarga y Combinacion exitosa"),
